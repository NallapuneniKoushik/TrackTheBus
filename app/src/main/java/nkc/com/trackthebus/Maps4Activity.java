...
public class Maps4Activity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
   ...
   // DatabaseReference dr;
    ...
    private void togglePeriodicLocationUpdates()
    {
        ...
        {
           // btnLocationUpdates.setText("Stop Location Updates");
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
          ...
          //  txtcoordinates.setText(latitude + "," + longitude);
            ...
            //txtcoordinates.setText("Could not fetch locaton ,Enable it");
                                    ...
                                    for(final  DataSnapshot ds:dataSnapshot.getChildren()){
                                        ...
                                        dr2.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                Intent i=new Intent(Maps4Activity.this,MapsActivity.class);

                                                i.putExtra("lat",latitude);
                                                i.putExtra("lag",longitude);
